...
export default function AnalysisDashboard({ analisis = null, viability = "viable", onDownload, onEnviarPorCorreo = () => {}, preAnalisisData = null }) {
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
          ...
          <div className="flex flex-col items-start gap-2.5 md:items-end">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              transition={spring}
              className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white/60 px-5 py-2.5 text-xs font-semibold text-neutral-700 backdrop-blur-xl transition-colors duration-150 hover:bg-white hover:text-black"
            >
            ...
            >
              ...
              Solicitar Autenticación y Firma Digital
            </motion.button>
            <AnimatePresence>
              {firmaSolicitada && (
                <motion.p
                ...
                >
                  Solicitud enviada. Un abogado colegiado se contactará para la autenticación y
